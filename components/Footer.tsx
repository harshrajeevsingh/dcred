...
const Footer =  () => {
    return(
        <footer className="gradient-bg-three">
<div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      <h2 className="text-3xl font-extrabold text-white sm:text-5xl text-gradient">
        Choose Your Product
      </h2>
      ...
      <a
        href="#"
        className="mt-8 inline-block rounded-full border border-[#3898ff] px-12 py-3 text-sm font-medium text-[#3898ff] hover:bg-[#3898ff] hover:text-white focus:outline-none focus:ring active:bg-[#3898ff]"
      >
        Get Started
      </a>
    </div>
    ...
    >
      ...
      <p className="mt-8 text-xs text-gray-200">
            &copy; 2022. Dcred. All rights reserved.
          </p>
      </ul>
